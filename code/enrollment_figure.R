...
calculate_average_needed_to_reach_goal <- function(df = cumulative_enrollment, end_date, enrollment_goal){
        ## calculate remaining enrollments
        enrollments_needed <- enrollment_goal - nrow(gwach_survey)
...
calculate_average_needed_to_reach_goal(end_date = '2022-03-15', enrollment_goal = 3000)
